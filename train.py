...
def train(model,batch_size=8, epochs=50, lr=1e-4 ,loss_name="dice"):
    ...
    os.makedirs(os.path.dirname(savepath), exist_ok=True) # Ensure directory exists for saving model
...
if __name__ == "__main__":
    ...
    model,train_losses,val_losses = train(args.model,epochs=args.epochs, lr=args.lr, batch_size=args.batch_size,loss_name=args.loss)
